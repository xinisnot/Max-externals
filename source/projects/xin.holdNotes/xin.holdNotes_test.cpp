...
#include "xin.holdNotes.cpp"    // need the source of our object so that we can access it
...
SCENARIO("object produces correct output") {
   ...
   GIVEN("An instance of our object") {
       ...
       test_wrapper<xin_holdNotes> an_instance;
       xin_holdNotes&              my_object = an_instance;
