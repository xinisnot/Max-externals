...
#include "max-externals.bin2dec.cpp"    // need the source of our object so that we can access it
...
SCENARIO("object produces correct output") {
   ...
   GIVEN("An instance of our object") {
       ...
       test_wrapper<max-externals_bin2dec> an_instance;
       max-externals_bin2dec&              my_object = an_instance;
