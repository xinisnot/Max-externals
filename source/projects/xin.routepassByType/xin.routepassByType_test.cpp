...
#include "xin.routepassByType.cpp"    // need the source of our object so that we can access it
...
SCENARIO("object produces correct output") {
   ...
   GIVEN("An instance of our object") {
       ...
       test_wrapper<xin_routepassByType> an_instance;
       xin_routepassByType&              my_object = an_instance;
