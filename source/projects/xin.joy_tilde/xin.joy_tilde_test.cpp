...
#include "xin.joy_tilde.cpp"    // need the source of our object so that we can access it
...
SCENARIO("object produces correct output") {
    ...
    GIVEN("An instance of our object") {
        ...
        test_wrapper<xin_joy_tilde> an_instance;
        xin_joy_tilde&              my_object = an_instance;
